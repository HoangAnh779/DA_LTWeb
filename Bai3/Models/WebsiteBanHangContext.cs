...
public partial class WebsiteBanHangContext : DbContext
{
    ...
    public IEnumerable<object> Banners { get; internal set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=HOANGANH\\MAY1;Database=WebsiteBanHang;Trusted_Connection=True;TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Blog>(entity =>
        {
            entity.HasKey(e => e.IdBlog).HasName("PK__BLOG__75519326B28013A1");
        ...
        {
            entity.HasKey(e => e.IdCart).HasName("PK__CART__7A1680A5940CE48A");
        ...
        {
            entity.HasKey(e => e.IdCd).HasName("PK__CART_DET__8B622F8F1885CA20");
        ...
        {
            entity.HasKey(e => e.IdCat).HasName("PK__CATOLOGY__2BF8FA1CF34C2CDF");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__MENU__4728FC6077D75ACF");
        ...
        {
            entity.HasKey(e => e.IdPro).HasName("PK__PRODUCTS__20AF98FD45A88BA3");
        ...
        {
            entity.HasKey(e => e.IdSlide).HasName("PK__SLIDER__22D1BB10C7ADCA5F");
        ...
        {
            entity.HasKey(e => e.IdUsers).HasName("PK__USERS__1DDB35C315F44B89");
